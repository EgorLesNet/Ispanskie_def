...
# ID группы комментариев, привязанной к каналу
# Узнать: написать любое сообщение в комментарии, переслать боту @RawDataBot
# Это chat_id той группы (обычно отрицательное число, например -1001987654321)
COMMENTS_CHAT_ID = -1001234567891

# Правила канала — публикуются в комментариях под каждым постом
CHANNEL_RULES = (
    "\U0001f4cb <b>Правила канала Испанские | Прокшино:</b>\n"
    "1. Уважайте друг друга\n"
    "2. Без спама и сомнительных ссылок\n"
